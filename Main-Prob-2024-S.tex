{"originatingScript":"m2","payload":{"guid":"8db16608-3c12-4923-ac20-a88f5761263e43d280","muid":"20ea20b2-dae6-42ea-8b37-2422056e7db56257e2","sid":"539e10ea-0d74-408a-8b48-cf34162eb794cbea9f"}}\documentclass[compress,table]{beamer}
...
%%%%%%%%%%%%%%%%%%% 设置字体方法一 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \setCJKmainfont[Path=./fonts/, Extension=.ttf, BoldFont=SimHei]{KaiTi_GB2312}
  %\setCJKmainfont[FandolHei]{FandolKai}
 \setCJKsansfont[Path=./fonts/, Extension=.ttf, BoldFont=SimHei]{KaiTi_GB2312}  % 设置中文字体
 %\setCJKsansfont[FandolHei]{FandolKai}  % 设置中文字体
 \XeTeXlinebreakskip = 0pt plus 1pt minus 0.1pt
 \setmainfont{Times New Roman} % 设置西文字体
\setmonofont[Path=./fonts/, Extension=.ttf]{NSimSun}
...
% \input{L11-2024.tex}
% \input{L12-2024.tex}
 %\input{L13-15-2024.tex}
 %\input{L16-20-2024.tex}
\input{L21-23-2024.tex}
